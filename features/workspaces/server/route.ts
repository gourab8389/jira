...
.get("/:workspaceId/analytics", sessionMiddleware, async (c) => {
    ...
    // this month and last month assigned tasks
    ...
    // this month and last month incomplete tasks
    ...
    // this month and last month completed  tasks
