    ...
    return (
        <DropdownMenu modal={false}>
            ...
            <DropdownMenuContent align="end" side="bottom" className="w-60" sideOffset={10}>
                <div className="flex flex-col items-center justify-self-center gap-2 px-2.5 py-4">
                    <Avatar className="size-[52px] border border-neutral-300">
                        <AvatarFallback className="bg-neutral-200 font-medium text-neutral-500 items-center justify-center text-xl">
                            {avatarFallback}
                        </AvatarFallback>
                    </Avatar>
